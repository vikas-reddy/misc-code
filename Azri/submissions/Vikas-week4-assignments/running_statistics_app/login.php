...
<html>
	<head>
		<title>Running Statistics Login</title>
		<link rel="stylesheet" type="text/css" href="../Azri_stylesheet.css" />
	</head>
	<body>
		<div class="container">
			<div class="heading">
				Running Statistics Login
			</div>
			<div class="main">
				<br /> <br />
...
// If user_name and password are not set OR are empty
...
else
{
	...
	mysql_select_db("RunningStatistics") or die(":( ERROR: " . mysql_error());
